...
BENCHMARKS: list[Benchmark] = [
    Benchmark(
        name="cube",
        scene_xml=Path("assets/mjcf/baseline/scenes/scene.xml"),
        keyframe="open",
    ...
    Benchmark(
        name="prism",
        scene_xml=Path("assets/mjcf/baseline/scenes/scene_prism.xml"),
        keyframe="open",
    ...
    Benchmark(
        ...
        scene_xml=Path("assets/mjcf/baseline/scenes/scene_screwdriver_medium.xml"),
        keyframe="open_flat",
    ...
    Benchmark(
        ...
        scene_xml=Path("assets/mjcf/baseline/scenes/scene_screwdriver_small.xml"),
        keyframe="open_flat",
    ...
    Benchmark(
        name="power_drill",
        scene_xml=Path("assets/mjcf/baseline/scenes/scene_power_drill.xml"),
        keyframe="open_flat",
    ...
    Benchmark(
        ...
        scene_xml=Path("assets/mjcf/baseline/scenes/scene_power_drill_short_proximal.xml"),
        keyframe="open_flat",
