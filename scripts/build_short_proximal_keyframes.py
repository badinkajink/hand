...
SPECS: list[ObjectSpec] = [
    ObjectSpec(
        label="cube",
        short_scene=ROOT / "assets/mjcf/scene_cube_short_proximal.xml",
    ...
    ObjectSpec(
        label="prism",
        short_scene=ROOT / "assets/mjcf/scene_prism_short_proximal.xml",
        original_keyframe="open",
        object_body="prism",
    ...
    ObjectSpec(
        ...
        short_scene=ROOT / "assets/mjcf/scene_screwdriver_medium_flat_short_proximal.xml",
        original_keyframe="open",
    ...
    ObjectSpec(
        ...
        short_scene=ROOT / "assets/mjcf/scene_screwdriver_medium_vertical_short_proximal.xml",
        original_keyframe="open",
        object_body="screwdriver_medium",
        mesh_obj=OBJECT_ASSETS_DIR / "screwdriver_medium_25x100mm.obj",
    ),
    ObjectSpec(
        ...
        short_scene=ROOT / "assets/mjcf/scene_screwdriver_small_flat_short_proximal.xml",
        original_keyframe="open",
