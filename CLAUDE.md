...
This has been the structure for the whole program. Writing findings into `RESULTS.md`,
`FINDINGS.md`, `NOTES.md` or a bare markdown summary is the wrong output and has been called out;
if a result is worth writing down it is worth building the page. Markdown under
`docs/experiments/` is for machine-readable runbooks and queues (`QUEUE.md`, `README.md`
describing how to re-run something), never for results prose.

The pattern, followed by every page in `docs/experiments/INDEX.md`:
